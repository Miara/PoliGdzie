...
public class SearchBuildingsFragment extends Fragment implements OnClickListener,Constants{
	...
	View rootView = inflater.inflate(R.layout.search_buildings_fragment, container,
			false);
	
	TextView testBazy = (TextView) rootView.findViewById(R.id.test_label);
    DatabaseHelper database = new DatabaseHelper(this.getActivity(), DATABASE_NAME, null, DATABASE_VERSION);
    try {
